...
contract_copies=(
  ...
  "flow-property-conversion-request.v1.schema.json:crates/tidas-conversion/contracts"
  "flow-property-conversion-report.v1.schema.json:crates/tidas-conversion/contracts"
